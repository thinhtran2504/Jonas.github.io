...
// Splash Screen
const Portfolio = () => {
  return React.createElement('div', null, 'Hello from Portfolio');
};
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/logagai.png"),
    ...
    },
    {
      role: "LEAD OF GAME",
      company: "Moli Studio",
      companylogo: require("./assets/moli.jpg"),
    ...
    },
    {
      ...
      company: "Bluestack",
      companylogo: require("./assets/BlueStacks.png"),
